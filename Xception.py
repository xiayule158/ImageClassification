...
image_root = '../data'
log_dir = './xceptionrelu_callbacks'
...
class Xception:
    ...
    def xceptionv3_entry(self, sc1, sc2, x):
        ...
        return keras.layers.Activation('relu')(p1 + shortcut_conv(x))
    ...
    def xceptionv3_middle(self, x):
        ...
        return keras.layers.Activation('relu')(p1 + x)
    ...
    def train(self):
        ...
        model_path = os.path.join(log_dir, 'xception.h5')
        callbacks = [
