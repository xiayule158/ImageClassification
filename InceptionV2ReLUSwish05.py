...
for gpu in physical_devices[2:3]:
    tf.config.experimental.set_memory_growth(gpu, True)
image_root = '../data'
log_dir = './inceptionv2reluswish05_callbacks'
...
class InceptionV2:
    ...
    def train(self):
        ...
        model_path = os.path.join(log_dir, 'inceptionv2_reluswish05.h5')
        callbacks = [
