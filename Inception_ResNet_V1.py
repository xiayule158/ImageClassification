...
image_root = '../data'
log_dir = './inception_resnet1_callbacks'
...
class InceptionResnetV1:
    ...
    def stem_module(self, x):
        ...
        x = keras.layers.Conv2D(filters=80, kernel_size=1, strides=1, padding='same', activation=r'relu')(x)
        x = keras.layers.Conv2D(filters=192, kernel_size=3, strides=1, padding='valid', activation=r'relu')(x)

        x = keras.layers.Conv2D(filters=256, kernel_size=3, strides=2, padding='valid', activation=r'relu')(x)
    ...
    def inception_res_A_module(self, x):
        ...
        p4_conv_2 = keras.layers.Conv2D(filters=32, kernel_size=3, strides=1, padding='same', activation=r'relu')
        p4_conv_3 = keras.layers.Conv2D(filters=32, kernel_size=3, strides=1, padding='same', activation=r'relu')
        ...
        x_2 = keras.layers.Conv2D(filters=256, kernel_size=1, strides=1, padding='same', activation=r'relu')(x_2)
        p1 = x
    ...
    def reduction_A_module(self, x):
        ...
        p3_conv_2 = keras.layers.Conv2D(filters=192, kernel_size=3, strides=1, padding='same', activation=r'relu')
    ...
    def inception_res_B_module(self, x):
        ...
        # branch2
        p2_conv_1 = keras.layers.Conv2D(filters=128, kernel_size=1, strides=1, padding='same', activation=r'relu')

        # branch3
        p3_conv_1 = keras.layers.Conv2D(filters=128, kernel_size=1, strides=1, padding='same', activation=r'relu')
        p3_conv_2 = keras.layers.Conv2D(filters=128, kernel_size=(1, 7), strides=1, padding='same', activation=r'relu')
        p3_conv_3 = keras.layers.Conv2D(filters=128, kernel_size=(7, 1), strides=1, padding='same', activation=r'relu')
        ...
        x_2 = keras.layers.Conv2D(filters=896, kernel_size=1,  strides=1, padding='same', activation=r'relu')(x_2)
    ...
    def reduction_B_module(self, x):
        ...
        p3_conv_2 = keras.layers.Conv2D(filters=256, kernel_size=3, strides=2, padding='valid', activation=r'relu')

        # 1×1-->3×3-->3×3
        p4_conv_1 = keras.layers.Conv2D(filters=256, kernel_size=1, strides=1, padding='same', activation=r'relu')
        p4_conv_2 = keras.layers.Conv2D(filters=256, kernel_size=3, strides=1, padding='same', activation=r'relu')
        p4_conv_3 = keras.layers.Conv2D(filters=256, kernel_size=3, strides=2, padding='valid', activation=r'relu')
    ...
    def inception_res_C_module(self, x):
        ...
        # branch3
        p3_conv_1 = keras.layers.Conv2D(filters=192, kernel_size=1, strides=1, padding='same', activation=r'relu')
        p3_conv_2 = keras.layers.Conv2D(filters=192, kernel_size=(1, 3), strides=1, padding='same', activation=r'relu')
        p3_conv_3 = keras.layers.Conv2D(filters=192, kernel_size=(3, 1), strides=1, padding='same', activation=r'relu')
        ...
        x_2 = keras.layers.Conv2D(filters=1792, kernel_size=1, strides=1, padding='same', activation=r'relu')(x_2)

        return keras.layers.Activation('relu')(p1 + x_2)

    def inception_res_v1(self):
        output_num = 3
    ...
    def train(self):
        ...
        model = self.inception_res_v1()
        batch_size = 32
        train_generator, val_generator = get_data(batch_size=batch_size)
        model_path = os.path.join(log_dir, 'inception_res_v1.h5')
        callbacks = [
    ...
    def get_data_from_log(self, log_path='./log/inception_res_v1_log.txt'):
        train_acc, val_acc = [], []
        train_loss, val_loss = [], []
        ...
        play_curve(epochs, train_acc, val_acc, fig_path='./train_val_plot/inception_res_v1_train_val_acc.jpg')
        play_curve(epochs, train_loss, val_loss, acc=False, fig_path='./train_val_plot/inception_res_v1_train_val_loss.jpg')
        return train_acc, val_acc, train_loss, val_loss, epochs


if __name__ == r'__main__':
    inceptionv_resnet1_obj = InceptionResnetV1()
    # inceptionv_resnet1_obj.inception_res_v1()
    # inceptionv_resnet1_obj.train()
    inceptionv_resnet1_obj.get_data_from_log()
