...
image_root = '../data'
log_dir = './inceptionv2relu_callbacks'
...
class InceptionV2:
    ...
    def inceptionv2_module_v1(self, n1_1, n2_1, n2_3, n3_1, n3_5, n4_1, x, is_max=False, strides=1):
        ...
        p4_ac1 = keras.layers.Activation('relu')
    ...
    def train(self):
        ...
        model_path = os.path.join(log_dir, 'inceptionv2_relu.h5')
        callbacks = [
