...
class InceptionV2:
    ...
    def inceptionv2(self):
        ...
        # 1 layers
        x = keras.layers.SeparableConv2D(filters=64, kernel_size=7, strides=2, padding='same', activation=r'relu')(inpt)
    ...
    def train(self):
        ...
        model_path = os.path.join(log_dir, 'inceptionv2_bn3.h5')
        callbacks = [
    ...
    def get_data_from_log(self, log_path='./log/inception_v2_bn3_log.txt'):
        train_acc, val_acc = [], []
        train_loss, val_loss = [], []
        ...
        play_curve(epochs, train_acc, val_acc, fig_path='./train_val_plot/inception_v2_bn3_train_val_acc.jpg')
        play_curve(epochs, train_loss, val_loss, acc=False, fig_path='./train_val_plot/inception_v2_bn3_train_val_loss.jpg')
...
if __name__ == r'__main__':
    ...
    inceptionv2_obj.get_data_from_log()